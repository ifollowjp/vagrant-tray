...
module.exports = new (function $IF() {
    ...
    const ICONFILES = {
        ...
        VAGRANT:        './img/icon-vagrant-16.png',
        VAGRANT16:      './img/icon-vagrant-16.png',
        VAGRANT32:      './img/icon-vagrant-32.png',
        VAGRANTLOGO:    './img/vagrant-logo-hashicorp.svg',
    ...
    const _init = function _init() {
        ...
        Object.defineProperty(global, 'exists', {
            value:          _exists,
            writable:       false,
            enumerable:     true,
            configurable:   true,
     ...
     * @param   {String}    title
     * @param   {String}    type    info|error|question|warning|none
     * @return  {Boolean}   true
     */
     ...
     */
    const _exists = function _exists(name) {
        let result = true;
        try {
